...
class ScheduleDefinition:
    ...
    Args:
        ...
        job (Optional[Union[GraphDefinition, JobDefinition]]): The job that should execute when this
            schedule runs.
        default_status (ScheduleStatus): Whether the schedule starts as running or not. The default
    ...
    def __init__(
        ...
        default_status: ScheduleStatus = ScheduleStatus.STOPPED,
    ):
        from .decorators.schedule import DecoratedScheduleFunction
        ...
        self._default_status = check.inst_param(default_status, "default_status", ScheduleStatus)
