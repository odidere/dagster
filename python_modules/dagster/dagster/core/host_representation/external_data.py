...
class ExternalScheduleData(
    namedtuple(
        ...
        "name cron_schedule pipeline_name solid_selection mode environment_vars partition_set_name execution_timezone description default_status",
    )
):
    def __new__(
        cls,
        ...
        return super(ExternalScheduleData, cls).__new__(
            ...
            if default_status == ScheduleStatus.RUNNING
            else None,
        )
...
class ExternalSensorData(
    ...
    def __new__(
        ...
        return super(ExternalSensorData, cls).__new__(
            ...
            default_status=SensorStatus.RUNNING if default_status == SensorStatus.RUNNING else None,
        )
